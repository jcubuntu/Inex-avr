...
/*
  Servo.cpp - Servo library for Arduino & Wiring
  Based on Hernando Barragan's original C implementation
  Copyright (c) 2006 Nicholas Zambetti.  All right reserved.
...
uint8_t Sm::attach(int pin)
{
  return this->attach(pin, MIN_PULSE_WIDTH, MAX_PULSE_WIDTH);
}

uint8_t Sm::attach(int pin, int min, int max)
{
...
void Sm::writeMicroseconds(int value)
{
...
int Sm::read() // return the value as degrees
{
  return  map( this->readMicroseconds()+1, SERVO_MIN(), SERVO_MAX(), 0, 180);     
}

int Sm::readMicroseconds()
{
